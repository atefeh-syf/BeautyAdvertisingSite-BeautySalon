        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <label data-error="wrong" data-success="right">نام خانوادگی </label>
              <input type="text" class="form-control">
              ...
              <label data-error="wrong" data-success="right"> رمز عبور </label>
              <input type="text" class="form-control">

              <label data-error="wrong" data-success="right"> وب سایت </label>
              <input type="text" class="form-control">

              <label data-error="wrong" data-success="right">درباره شما</label>
