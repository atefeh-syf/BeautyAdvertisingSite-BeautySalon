                            ...
                            <ul class="navbar-nav mr-auto" id="dorneMenu">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> گروه ها <i
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> استان ها <i
                                            class="fa fa-angle-down" aria-hidden="true"></i></a>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-heading-lists dark text-center">
                    <h4>آگهی های لوازم آرایشی و بهداشتی</h4>
                    <span></span>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="single-features-area mb-50">
                    ...
                    <div class="price-start">
                        <p> فروشگاه لوازم آرایشی بهداشتی کرکره </p>
                    </div>
            ...
            <div class="row">
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>
                            طراحی شده با <i class="fa fa-heart-o" aria-hidden="true"></i> توسط <a href=# target="_blank">
                                تیم ما</a>
                        </p>
                    </div>
